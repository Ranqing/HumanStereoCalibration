...
public:
    ...
    ~Qing_Stereo_Calibrater() {}
    Qing_Stereo_Calibrater(const string& data_folder, const string& mono_folder, const string& cam0, const string& cam1 );
    ...
    string m_data_folder, m_mono_folder, m_cam0, m_cam1, m_out_folder, m_out_file;           //input informations
    vector<string> m_imageNames0, m_imageNames1;                                             //calibration image names
    ...
    void init();                                          //initial calibrate image names, and mono-calibrate results
    void calib();                                         //stereo calibration
